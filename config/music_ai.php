...
return [
    ...
    'studio_url' => rtrim((string) music_env('MUSIC_AI_STUDIO_URL', 'http://127.0.0.1:8093'), '/'),
    'studio_token' => (string) music_env('MUSIC_AI_STUDIO_TOKEN', music_env('MUSIC_AI_GENERATOR_TOKEN', '')),
    'studio_timeout' => max(60, (int) music_env('MUSIC_AI_STUDIO_TIMEOUT', 1800)),
